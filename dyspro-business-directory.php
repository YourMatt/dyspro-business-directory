...
$dbd_shortcode_manager = new dbd_shortcode_manager ();
...
// set up actions
add_action ('init', array ($dbd_plugin_manager, 'register_business_taxonomy'));
...
// set up shortcodes
add_shortcode ('dbd_directory_list', array ($dbd_shortcode_manager, 'build_directory_list'));
add_shortcode ('dbd_category_list', array ($dbd_shortcode_manager, 'build_category_list'));